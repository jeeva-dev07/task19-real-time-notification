...
def create_order():
    ...
    try:
        ...
        message = f"New order #{order_id} placed by {customer_name} - ₹{total}"
        ...
        notification_cursor = db.cursor(dictionary=True)
        ...
        notification = notification_cursor.fetchone()
        ...
        if notification:
            ...
            print("DB created_at :", notification["created_at"])
